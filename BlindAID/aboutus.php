...
.top-nav li.active> a, .top-nav li> a:hover {
  ...
  border-left-color:rgb(50, 133, 209);
      ...
      <body>
        ...
        <!--start-logo-->
        <div class="logo">
          <a href="index.html" style="font-size: 30px;"> <h1>About Us</h1></a>
        </div>
        <!--end-logo-->
        <!--start-top-nav-->
        <div class="top-nav">
  ...
  <section class="story-section company-sections ct-u-paddingBoth100 paddingBothHalf noTopMobilePadding" id="section">
    <div class="container text-center">
      ...
      <div class="col-md-8 col-md-offset-2">
        ...
        <p class="ct-u-size22 ct-u-fontWeight300 marginTop40">We welcome you to one of the most successfull hospital of all time.</p>
