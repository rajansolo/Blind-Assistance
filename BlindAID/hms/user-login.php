...
.top-nav li.active> a, .top-nav li> a:hover {
	...
	<body class="login">
		<div class="top-nav">
					<ul>
						<li class="active"><a href="http://localhost:8015/BlindAid2/">Home</a></li>

						<li><a href="http://localhost:8015/BlindAid2/contact.php">contact</a></li>
					</ul>
				</div>
		<div class="row">
					...
					speechRecognizer.onresult = function(event){
						...
						for(var i = event.resultIndex; i < event.results.length; i++){
							...
							if(event.results[i].isFinal){
								...
								{
									window.location.replace("http://localhost:8015/BlindAid2/index.php");
								}
								...
								if(finalTranscripts.includes('Yahoo') || finalTranscripts.includes('yahoo'))
								{
									...
									email = email.replace(/ /g,"");
									document.getElementById('username').value = email+"@yahoo.com";
									finalTranscripts = "";
								}
