	...
	<body>
		...
		<script type="text/javascript">
			...
			function startConverting () {
				var msg = new SpeechSynthesisUtterance('Say your username followed by the term Username');
				window.speechSynthesis.speak(msg); 
				var msg = new SpeechSynthesisUtterance('Say your password followed by the word password');
				window.speechSynthesis.speak(msg);
